								...
								{showWalletConnection ? (
									walletConnected ? (
										...
										<div className="modal-back-header">
											<div style={{ cursor: "pointer" }} onClick={this.cancelWalletConnection}>
												Back
											</div>
										</div>
									)
									...
									<div className="modal-back-header">
										<div style={{ cursor: "pointer" }} onClick={this.backToAccountSection}>
											Back
										</div>
									</div>
								) : (
												...
												<div className="connected-wallet-container" style={{ paddingTop: "1rem" }}>
													...
													<div className="wallet-address-container">
														<div className="wallet-address-inner-container">
															...
															<p>
																{`${this.state.walletAddress}`.substring(0, 6) +
																	"..." +
																	`${this.state.walletAddress}`.substring(37, 42)}
															</p>
														</div>
													</div>
													<div className="wallet-address-container">
											...
											<div className="modal-content-grid">
												{window.innerWidth > 900 ? (
													<button
														...
														onClick={() => this.connectToWallet("metamask")}
													>
														<div
												...
												<button
													...
													onClick={() => this.connectToWallet("walletConnect")}
													style={{
														display: "flex",
												...
												<button
													...
													onClick={() => this.connectToWallet("trustwallet")}
													style={{
														display: "flex",
