			...
			<>
				<div className="pool-form">
					...
					<div className="form-control" style={{ textTransform: "none" }}>
						...
						>
							<div
								className="flex-spaced-container pool-amount-row"
								style={{ alignItems: "flex-start" }}
							>
								<div>
									Liquidity: {parseFloat(parseFloat(tokensInPool) * (percent / 100)).toFixed(6)}
								</div>
								<div>
							...
							>
								<div>
									Remaining:{" "}
									{parseFloat(
										parseFloat(tokensInPool) - parseFloat(tokensInPool) * (percent / 100)
									).toFixed(6)}
								</div>
