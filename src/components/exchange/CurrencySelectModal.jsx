...
export default class CurrencySelectModal extends Component {
    ...
    render() {
        const { onModalClose, walletConnected, walletAddress, onTokenSelect, selectedToken, theme } = this.props;
        ...
        return (
            ...
            >
                ...
                <div className="modal-content" style={{paddingBottom: 0, paddingTop: '15px', borderRadius: 0}}>
                ...
                <div className="currency-rows-container">
                    {!searchedToken ? allTokens.map((token, index) => {
                        return (
                            <TokenRow
                                theme={theme}
                                key={index+1}
