...
export default class Sale extends Component {
  ...
  returnDate = ({ days, hours, minutes, seconds }) => {
    return (
      <code style={{ fontFamily: "monospace", marginLeft: "5px" }}>
        ...
        <div className="sale-grid-container">
              ...
              <div className="sale-block-inner-grid-wrapper">
                <div className="sale-block-inner-grid">
                  <div className="sale-block-title-container">
                    <div className="sale-block-title">VeraSwap token sale</div>
                  </div>
                  <div className="sale-block-content-container">
                    <div className="sale-block-content">
                      The VRAP Public Crowdsale will consist of 3 rounds with different prices
                      ranging from $0.05 to $0.075 to allow more community members to participate in
                      the sale. When the first round is sold out, the second round will begin
                      immediately. Your tokens are distributed immediately to your wallet.{" "}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="countdown-container">
            <div className="countdown">
              Pre Sale Round {this.state.phase} ($
              {parseFloat(this.state.price).toFixed(3)} per VRAP) ends in{" "}
              {<Countdown date={new Date(1614949200000)} renderer={this.returnDate} />}
            </div>
          </div>
          <div className="sale-block-outer-container-wrapper" style={{ gap: "24px" }}>
            <div className="sale-block-2-outer-container">
              ...
              <div className="sale-block-inner-grid-wrapper">
                <div className="sale-block-inner-grid">
                  <div className="sale-block-title-container">
                    <div className="sale-block-title">Your balance</div>
                  </div>
                  <div className="sale-block-content-container" style={{ alignItems: "baseline" }}>
                    <div className="balance">
                      {this.props.vrapBalance === ""
                        ? "-"
                        : parseFloat(this.props.vrapBalance).toFixed(3)}
                    </div>
                    <div className="sale-block-title">VRAP</div>
                  </div>
                </div>
              </div>
              <span className="sale-rotation"></span>
          ...
          <div className="buy-container" style={{ marginBottom: "1rem" }}>
            <button
              ...
              onClick={() =>
                notification["info"]({
                  message: "Phase 3 Ended Successfully. We will update you shortly",
                })
              }
            >
              Sale Ended
          ...
          {this.state.txSuccess ? (
            <div className="buy-modal-grid">
              ...
              >
                ...
                automatically credited to your wallet address. If you wish to track your transaction{" "}
                <a
                  href={`https://bscscan.com/tx/${this.state.txHash}`}
                  target="_blank"
            ...
            <div className="buy-modal-grid">
              <div className="buy-modal-header">
                <div className="buy-modal-title">
                  Buy VRAP with{" "}
                  {this.state.currentToken === "ETH" ? "BNB" : this.state.currentToken}
                </div>
                <svg
                  style={{ cursor: "pointer" }}
                  onClick={() =>
              ...
              {this.state.error ? (
                <p className="connected-wallet-footer-text">
                  Error occured while purchasing VRAP tokens. Please contact support.
                </p>
              ) : null}
                    ...
                    <div className="available-deposit-inner-container">
                      ...
                      >
                        ...
                        {this.state.currentToken === "ETH"
                          ? parseFloat(this.props.ethBalance).toFixed(4)
                          : parseFloat(this.props.usdtBalance).toFixed(4)}
                      </div>
                    </div>
                  </div>
                ...
                {this.state.currentToken === "ETH" ? (
                  <div className="received-amount">
                    {parseFloat(this.state.depositAmount) < 0
                      ...
                      ? 0.0
                      : parseFloat(
                          (parseFloat(this.state.depositAmount) * parseFloat(this.state.ethPrice)) /
                            parseFloat(this.state.price)
                        ).toFixed(4)}
                  ...
                  <div className="received-amount">
                    {parseFloat(this.state.depositAmount) < 0
                      ...
                      : isNaN(
                          parseFloat(
                            parseFloat(this.state.depositAmount) / parseFloat(this.state.price)
                          ).toFixed(4)
                        )
                      ? 0.0
                      : parseFloat(
              ...
              {this.state.currentToken === "ETH" ? (
                ...
                <div className="buy-modal-header">
                  <button
                    ...
                    className="buy-action-button"
                    onClick={() => {
                      this.props.approveTether(this.state.depositAmount);
                    }}
                  >
                    {this.props.approving ? (
                      <div className="transaction-status">
              ...
              {this.state.currentToken === "ETH" ? null : (
                <div
                  style={{
                    display: "grid",
                    gridAutoRows: "auto",
                  ...
                  <div style={{ width: "100%" }}>
                    <div
                      ...
                      className={
                        this.state.currentToken === "ETH"
                          ? "individual-token"
                          : "individual-token token-disabled"
                      }
                    >
                      <img
                        style={{
