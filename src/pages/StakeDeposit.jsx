			...
			<div>
				...
				<div
					style={{
						...
						marginLeft: window.innerWidth < 720 ? "2%" : "0",
						width: window.innerWidth < 720 ? "96%" : "100%",
						paddingTop: window.innerWidth < 600 ? "30px" : "100px",
				...
				>
					...
					>
									...
									this.state.icon.map((icon) => {
										return (
											<img
												width="24px"
												height="24px"
												style={{ borderRadius: "24px", boxShadow: "rgb(0 0 0 / 8%) 0px 6px 10px" }}
												alt={`logo`}
												src={icon}
											/>
										);
						...
						>
							...
							<div
								className="text-semibold shaded-text"
					...
					{this.props.stakeSuccess || txSuccess ? (
						<div className="buy-modal-grid">
							...
							<p
								...
								style={{ width: "80%", marginLeft: "10%", textAlign: "center", lineHeight: "2rem" }}
							>
						...
						<div className="buy-modal-grid">
							<div className="buy-modal-header">
								...
								<svg
									...
									onClick={() =>
										this.setState(
											{ depositModalVisible: false, depositAmount: "", error: false },
											() => this.props.onResetStakeStatus()
										)
									}
									xmlns="http://www.w3.org/2000/svg"
								...
								<div className="buy-inner-container">
									...
									<div className="deposit-input-container">
										<input
											...
											value={depositAmount}
											onChange={(e) =>
												this.setState({ depositAmount: e.target.value, error: false })
											}
										/>
										<button
										...
										<button className="token-select-button">
											...
											>
												<img
													...
													src={this.state.icon}
												/>
												<span style={{ margin: "0px 0.25rem 0px 0.75rem", fontSize: "20px" }}>
													{this.state.ticker}
												</span>
											</span>
										</button>
							...
							<div style={{ display: "grid", gridAutoRows: "auto", justifyContent: "center" }}>
								...
								>
									<div
										style={{ width: "calc(100% - 20px)", display: "flex", alignItems: "center" }}
									>
