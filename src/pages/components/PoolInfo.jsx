...
export default class xPoolInfo extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			totalDeposit: 0.0,
	...
	async componentDidMount() {
		if (this.props.ticker && this.props.currentToken) {
			...
			let balance = await contract.balanceOf(
				this.props.version === "1" ? STAKING_ADDRESS_V1 : STAKING_ADDRESS
			);
			...
			<div className="stake-deposits-info-banner">
				...
				>
					<div className="outlined-box">
						...
						>
							<div className="text-regular" style={{ fontSize: "17px" }}>
								Total deposits
							</div>
							<div className="text-semibold" style={{ fontSize: "24px" }}>
								{parseFloat(this.state.totalDeposit).toFixed(4)} {this.props.ticker}
							</div>
						</div>
					</div>
					<div className="outlined-box">
						...
						>
							<div className="text-regular" style={{ fontSize: "16px" }}>
								Pool Rate
							</div>
							<div className="text-semibold" style={{ fontSize: "24px" }}>
								{this.state.poolRate} %
