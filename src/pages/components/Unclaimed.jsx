...
export default class Unclaimed extends React.Component {
	...
	fetch(walletAddress) {
		...
		contract
			.fetchUnclaimed(walletAddress, this.props.currentToken)
			.then((res) => {
	...
	render() {
		return (
			<div style={{ display: "grid", gridAutoRows: "auto", rowGap: "27px" }}>
				<div
					style={{
						display: "flex",
						alignItems: "center",
				...
				>
					<div className="text-semibold-2x" style={{ fontSize: "24px" }}>
